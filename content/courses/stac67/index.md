...
| Week 2 <br/>14–20 September<br/>         | Least squares estimation; the Gauss–Markov theorem; interpretation of $\sigma^2$; fitted values and residuals [Lecture 3](Lecture3.pdf)<br/><br/> Inference on the regression parameters: confidence intervals and hypothesis tests                               | Kutner 1.4–1.7 <br/> Kutner 2.1–2.2                                             | [Problem Set 1](STAC67-ProblemSet1.zip): random variables and ggplot2 in R; sampling distributions by simulation                               | Assignment 1 out (Sep 18)                                                     |
