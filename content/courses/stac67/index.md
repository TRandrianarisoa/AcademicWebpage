...
| Week 2 <br/>14–20 September<br/>         | Least squares estimation; the Gauss–Markov theorem; interpretation of $\sigma^2$; fitted values and residuals <br/> [Lecture 3](Lecture3.pdf)<br/><br/> Inference on the regression parameters: confidence intervals and hypothesis tests  <br/>  [Lecture 4](Lecture4.pdf)/[Lecture4_annotated.pdf](Lecture4_annotated.pdf) | Kutner 1.4–1.7 <br/> Kutner 2.1–2.2                                             | [Problem Set 1](STAC67-ProblemSet1.zip): random variables and ggplot2 in R; sampling distributions by simulation                               |  [Assignment 1 out](A1.pdf) (Sep 18)                                                    |
| Week 3 <br/>21–27 September<br/>         | Sampling distribution of the estimators; interval estimation of the mean response; prediction intervals <br/><br/> Analysis of variance; the coefficient of determination                                                                                                    | Kutner 2.3–2.6 <br/> Kutner 2.7–2.9                                             |                   |                                                                               |
...
|:-----------------|:---------------|:---------------------------------|:----------|
| **[Assignment 1](A1.pdf)** | September 18th | October $2^{\text{nd}}$, 23:59   |           |
